...
\textbf{1. Naturaleza del Pop y Control Social:} Se define el Pop no
solo como género, sino como un producto de consumo rápido diseñado para
la masa juvenil. Su capacidad de absorción y repetición melódica actúa
como un mecanismo que influye en la forma de pensar y sentir de los
adolescentes, fomentando la imitación pasiva.

\textbf{2. Estructura de Mercado (Oligopolio):} La industria no es un
campo diverso, sino un oligopolio dominado por tres grandes sellos
(majors): Sony Music, Universal Music Group y Warner Music Group. Estas
corporaciones controlan la producción, distribución y el éxito comercial
a nivel global.

\textbf{3. Estandarización y Limitación Cultural:} La relación entre el
dominio de las majors y las características del Pop sugiere una
estandarización sonora. Al imponer modelos métricos y rítmicos
uniformes, las discográficas limitan el acceso a la diversidad musical,
condicionando al público a un modelo único de consumo.
